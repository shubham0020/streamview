...
(function() {
  ...
  $.awesomeCropper = function(inputAttachTo, options) {
    ...
    input = function(type) {
      return $(`<label for="my-file" class="custom-file-upload"><img src="http://localhost:8000/images/default.png" class="custom-file-upload-img"></label><input type = "${type}" id="my-file"/>`);
    };
    div = function() {
      return $("<div/>");
    };
    ...
    saveCrop = function() {
      ...
      // console.log(result);
      $('.custom-file-upload-img').attr('src', result);
