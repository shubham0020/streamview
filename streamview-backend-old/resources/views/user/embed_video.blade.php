...
<!-- <div class="embed-responsive embed-responsive-16by9" id="flash_error_display" style="display: none;">
   <div style="width: 100%;background: black; color:#fff;">
         <div style="text-align: center;align-items: center;">Flash is missing. Download it from <a target="_blank" href="https://get.adobe.com/flashplayer/" class="underline">Adobe</a>.</div>
   </div>
</div> -->
