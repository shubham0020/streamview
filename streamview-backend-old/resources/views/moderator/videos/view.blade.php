            ...
            <div class="box box-primary">
                <div class="box-header with-border">
                    <div class='pull-left'>
                        ...
                        <br>
                        <span style="margin-left:0px" class="description text-uppercase">{{tr('created_at')}} :

                            {{convertTimeToUSERzone($video->video_date, Auth::guard('moderator')->user()->timezone, 'd-m-Y h:i A')}}</span>
