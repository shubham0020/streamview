...
<body class="hold-transition skin-yellow sidebar-mini" style="letter-spacing: 0.3px;">
    ...
    <div class="wrapper {{Auth::guard('admin')->user()->role}}">
		...
		@elseif(Auth::guard('admin')->user()->role == STORE)

            @include('layouts.admin.store-header')

            @include('layouts.admin.store-nav')
