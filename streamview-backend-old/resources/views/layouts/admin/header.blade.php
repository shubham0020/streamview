<header class="main-header theme-bg">
    <!-- Logo -->
    <a href="{{route('admin.dashboard')}}" class="logo theme-bg">
    ...
    <nav class="navbar navbar-static-top theme-bg">
        ...
        <div class="navbar-custom-menu">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown notifications-menu">
                    ...
                    <a href="{{Setting::get('ANGULAR_SITE_URL')}}" class="btn btn-default visit-website" target="_blank"> 
                        <i class="fa fa-globe"></i>
                        <span class="f-16">{{tr('visit_website')}}</span>
                      ...
                      <!-- Menu Footer-->
                        <li class="user-footer">
                            ...
                            <div class="pull-right">
                                <a href="{{route('admin.logout')}}" onclick="return confirm(&quot;{{ tr('logout_confirmation') }}&quot;)" class="btn btn-default btn-flat">{{tr('logout')}}</a>
                            </div>
                        </li>
                    </ul>
                </li>
