            ...
            <div class="row">
                ...
                <div class="col-xs-6">
                    ...
                    @if(in_array($data->redeem_request_status ,[REDEEM_REQUEST_SENT , REDEEM_REQUEST_PROCESSING]))
                        ...
                        @if($data->moderator_details->paypal_email)

                        <br>

                        <br>

                        <form action="{{Setting::get('redeem_paypal_url')}}" method="post">
                            @csrf
                            ...
                            <input name = "business" value = "{{$data->moderator_details ? $data->moderator_details->paypal_email : ''}}" type = "hidden">
