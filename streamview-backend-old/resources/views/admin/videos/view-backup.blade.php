                            ...
                            <div class="col-lg-6">
                                ...
                                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="item">
                                            <img src="{{$video->mobile_image}}" alt="{{tr('mobile_image')}}">
                                        ...
                                        <div class="item">
                                            <img src="{{$video->banner_image}}" alt="{{tr('banner_image_for_website')}}">
                                        ...
                                        @if($video->mobile_banner_image)
                                        <div class="item">
                                            <img src="{{$video->mobile_banner_image}}" alt="{{tr('mobile_banner_image')}}">
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function(){
                ...
                @if($videoStreamUrl)
                    ...
                    var videoPath = "https://vipscreen-india.s3.ap-south-1.amazonaws.com/SV-2021-08-17-07-42-33-0f2519b6b15617dead6fc9516a9068486c6321da.mkv";
