            ...
            <div class="box box-warning">
                ...
                <div class="box-header table-header-theme">
                    ...
                    <div class='pull-right'>
                        ...
                        @else
                            <a href="{{route('admin.videos.edit' ,['admin_video_id' => $video->video_id] )}}" class="btn bg-orange text-uppercase">
                            ...
                            <div class="col-md-6">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td>{{tr('category')}}</td>
                                        <td>
                                         <a href="{{route('admin.categories.view',['category_id'=>$video->category_id])}}">
                                        {{$video->category_name}}
                                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <a href="{{ route('admin.sub_categories.view',['category_id' => $video->category_id ,'sub_category_id' => $video->sub_category_id ])  }}">
                                    ...
                                    <tr>
                                        <td><b>{{tr('is_original_video')}}</b></td>
                                        <td>
                                            @if($video->is_original_video ==  YES) 
                                    ...
                                    <tr class="text-center">
                                        <td><b>{{tr('downloadable')}}</b></td>
                                        <td>
                                        @if($video->download_status )
                                        <span class="text-green text-uppercase"><b>{{tr('yes')}}</b></span>
                                    ...
                                    <tr>
                                        <td>{{tr('revenue')}}</td>
                                        <td>{{ formatted_amount($video->admin_amount)}}</td>
                                    </tr>
                                ...
                                <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item active">
                                            <img src="{{isset($video->default_image) ? $video->default_image : ''}}" alt="{{tr('default_image')}}" class="img img-responsive" style="max-height: 400px;object-fit: contain;">
                                        ...
                                        @if($video->mobile_image)

                                        <div class="item">
                                            <img src="{{$video->mobile_image}}" alt="{{tr('mobile_image')}}" style="max-height: 400px;object-fit: contain;">
                                        ...
                                        @if($video->mobile_banner_image)

                                        <div class="item">
                                            <img src="{{$video->banner_image}}" alt="{{tr('banner_image_for_website')}}" style="max-height: 400px;object-fit: contain;">

                                            <div class="carousel-caption">
                                                {{tr('banner_image_for_website')}}
                                            </div>
                                        </div>
                                        @endif
                                        ...
                                        @if($video->mobile_banner_image)
                                        <div class="item">
                                            <img src="{{$video->mobile_banner_image}}" alt="{{tr('mobile_banner_image')}}" style="max-height: 400px;object-fit: contain;">

                                            <div class="carousel-caption">
                                                {{tr('mobile_banner_image')}}
                                            </div>
                                        </div>
                        ...
                        <div class="row">
                            ...
                            @if($video->trailer_video)
                                ...
                                <div class="col-lg-6">
                                    ...
                                    @if($video->video_type == VIDEO_TYPE_VIMEO)
                                        <div class="">
                                            <iframe title="vimeo-player" src="{{$trailerstreamUrl}}" width="500" height="300" frameborder="0" allowfullscreen></iframe>
                                        </div>
                                    @else
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="">
                                    ...
                                    @if($video->video_type == VIDEO_TYPE_UPLOAD)
                                        ...
                                        <video id="dotsub_example" class="video-js vjs-default-skin" width="640" height="320" style="width:100%" poster="{{$video->default_image}}" controls preload="auto" data-setup='[]'>
                                            <source src="{{$videoStreamUrl}}" type='video/mp4' />
                                            <source src="{{$videoStreamUrl}}" type='video/mkv' />
                                            <source src="{{$videoStreamUrl}}" type='video/webm' />

                                            @if($video->video_subtitle)

                                                <track kind='captions' src="{{$video->video_subtitle}}" srclang='en' label='English' default />
                                            @endif
                                    ...
                                    @elseif($video->video_type == VIDEO_TYPE_VIMEO)
                                        <div class="">
                                            <iframe title="vimeo-player" src="{{$videoStreamUrl}}" width="500" height="300" frameborder="0" allowfullscreen></iframe>
                                        </div>
                                    @else
    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function(){
                ...
                @if($videoStreamUrl)
                    ...
                    if ($('#main-video-player').length) {

                        var playerInstance = jwplayer("main-video-player");

                        var videoPath = "{{$videoStreamUrl}}";
                ...
                @if($trailerstreamUrl)
                    ...
                    if ($('#trailer-video-player').length) {

                        var playerInstance = jwplayer("trailer-video-player");

                        var trailerVideoPath = "{{$trailerstreamUrl}}";
