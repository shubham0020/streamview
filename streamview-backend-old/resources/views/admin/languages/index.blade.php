...
@section('breadcrumb')
    ...
    <li class="active">{{tr('view_languages')}}</li>
@endsection
        ...
        <div class="col-xs-12">
            ...
            <div class="box box-warning">
                ...
                <div class="box-header table-header-theme">
                    <h2 class="box-title"> <b>{{tr('view_languages')}}</b></h2>
                    <a href="{{route('admin.languages.create')}}" style="float:right" class="btn btn-default"><i class="fa fa-plus"></i>  {{tr('add_language')}}</a>
                </div>
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('admin.languages.download', array('folder_name' => $language_details->folder_name, 'file_name'=>'messages'))}}" target="_blank">
                                            {{tr('download_here')}}
                                        </a>
                                    ...
                                    <td>
                                        <a href="{{route('admin.languages.download', array('folder_name'=>$language_details->folder_name, 'file_name'=>'pagination'))}}" target="_blank">
                                            {{tr('download_here')}}
                                        </a>
                                    </td>
                                    
                                    <td>
                                        <a href="{{route('admin.languages.download', array('folder_name'=>$language_details->folder_name, 'file_name'=>'passwords'))}}" target="_blank">
                                            {{tr('download_here')}}
                                        </a>
                                    ...
                                    <td>
                                        <a href="{{route('admin.languages.download', array('folder_name'=>$language_details->folder_name, 'file_name'=>'validation'))}}" target="_blank">
                                            {{tr('download_here')}}
                                        </a>
