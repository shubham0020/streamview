<form  action="{{Setting::get('admin_delete_control') == YES  ? '#' : route('admin.languages.save') }}" method="POST" enctype="multipart/form-data" role="form">
	...
	<div class="box-body">
	    ...
	    <div class="form-group">
	        ...
	        <input type="file" id="messages_file" name="messages_file"  accept=".php" placeholder="{{ tr('picture') }}">
	         <br>
	        <ul class="ace-thumbnails clearfix" style="list-style-type: none;">
	            <li>	                
	                <div class="tools tools-bottom">
	    ...
	    <div class="form-group">
	        ...
	        <input type="file" id="pagination_file" name="pagination_file" accept=".php" placeholder="{{ tr('picture') }}">
	         <br>
	        <ul class="ace-thumbnails clearfix" style="list-style-type: none;">
	            <li>	                
	                <div class="tools tools-bottom">
	    ...
	    <div class="form-group">
	        ...
	        <input type="file" id="passwords_file" name="passwords_file" accept=".php" placeholder="{{ tr('picture') }}">
	         <br>
	        <ul class="ace-thumbnails clearfix" style="list-style-type: none;">
	            <li>
	                <div class="tools tools-bottom">
	    ...
	    <div class="form-group">
	        ...
	        <input type="file" id="validation_file" name="validation_file" accept=".php" placeholder="{{ tr('picture') }}">
	         <br>
	        <ul class="ace-thumbnails clearfix" style="list-style-type: none;">
	            <li>	                
	                <div class="tools tools-bottom">
