            ...
            <div class="box box-warning">
                ...
                <div class="box-body box-profile">
                    ...
                    <ul class="list-group list-group-unbordered">
                        ...
                        <li class="list-group-item">
                            <b>{{ tr('address') }}: </b>{{ Auth::guard('admin')->user()->address }}
                        </li>
                    </ul>
            ...
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    ...
                    <div class="active tab-pane" id="adminprofile">
                        ...
                        <form class="form-horizontal" action="{{ (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.save.profile') }}" method="POST" enctype="multipart/form-data" role="form">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                  <input type="text" class="form-control" id="name"  name="name" value="{{ old('name') ?: Auth::guard('admin')->user()->name }}" pattern="[a-zA-Z]+" placeholder="{{ tr('username') }}" required title="{{ tr('only_for_alpha_values') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" class="btn btn-danger" @if(Setting::get('admin_delete_control') == YES ) disabled @endif>{{ tr('submit') }}</button>
                        ...
                        <form class="form-horizontal" action="{{  (Setting::get('admin_delete_control') == YES ) ? '#' : route('admin.change.password') }}" method="POST" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-2 col-sm-10">
                                    ...
                                    <button type="submit" id="change_password_submit" class="btn btn-danger change_password_submit" @if(Setting::get('admin_delete_control') == YES ) disabled @endif>{{ tr('submit') }}</button>
