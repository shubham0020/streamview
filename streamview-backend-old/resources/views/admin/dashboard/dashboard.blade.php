...
@if(Auth::guard('admin')->user()->role == STORE)
...
<div class="row">
    ...
    <div class="col-lg-3 col-xs-6">
      	...
      	<div class="small-box bg-orange">
        	...
        	<a href="{{ route('admin.moderators.index') }}" class="small-box-footer">
          		{{ tr('more_info') }}
          		<i class="fa fa-arrow-circle-right"></i>
        	</a>
      	</div>
    ...
    <div class="col-lg-3 col-xs-6">
        ...
        <div class="small-box bg-teal">
            <div class="inner">
                <h3>{{Setting::get('currency')}} {{ number_format_short($total_revenue)}}</h3>
            ...
            <a href="{{ route('admin.revenue.dashboard') }}" class="small-box-footer">
                {{ tr('more_info') }}
                <i class="fa fa-arrow-circle-right"></i>
            </a>
        </div>
                            ...
                            @if($v < 5)
                                <li class="item">
                                    ...
                                    <div class="product-info">
                                        <a href="{{ route('admin.view.video' , ['id' => $video_details->id] ) }}" class="product-title">{{ substr($video_details->title, 0,50) }}
                                            <span class="label label-warning pull-right">{{ $video_details->duration }}</span>
                                        </a>
                                        <span class="product-description">
                                          {{ substr($video_details->description , 0 , 75) }}
                                        </span>
                                  </div>
                                </li>
