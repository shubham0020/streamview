                ...
                <form action="{{route('save_admin_control')}}" method="POST" role="form">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <br>
                            <label>
                                <input required type="radio" name="admin_delete_control" value="1" class="flat-red" @if(Setting::get('admin_delete_control') == DEFAULT_TRUE) checked @endif>
                                {{tr('yes')}}
                            </label>

                            <label>
                                <input required type="radio" name="admin_delete_control" class="flat-red"  value="0" @if(Setting::get('admin_delete_control') == DEFAULT_FALSE) checked @endif>
                                {{tr('no')}}
                            </label>
                        </div>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <br>
                            <label>
                                <input required type="radio" name="ffmpeg_installed" value="1" class="flat-red" @if(Setting::get('ffmpeg_installed') == DEFAULT_TRUE) checked @endif>
                                {{tr('yes')}}
                            </label>

                            <label>
                                <input required type="radio" name="ffmpeg_installed" class="flat-red"  value="0" @if(Setting::get('ffmpeg_installed') == DEFAULT_FALSE) checked @endif>
                                {{tr('no')}}
                            </label>
                        </div> -->
