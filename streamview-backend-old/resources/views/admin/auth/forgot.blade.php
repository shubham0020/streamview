...
<div class="login-box-body" style="height:300px">
    ...
    <form class="form-layout" role="form" method="POST" action="{{route('admin.forgot_password.update')}}">
        @csrf
        ...
        <div class="form-inputs">
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <input type="email" class="form-control" name="email" value="{{ old('email') }}" placeholder="{{tr('email_add')}}" required>
