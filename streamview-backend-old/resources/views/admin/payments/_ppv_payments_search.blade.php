<div class="col-xs-12 mb-2  bottom-space">
    ...
    <form class="col-sm-6 col-sm-offset-6" action="{{route('admin.user.video-payments')}}" method="GET" role="search">
        @csrf
        <div class="flex right-box">
            ...
            <a class="btn btn-default box-left" href="{{route('admin.user.video-payments')}}">{{tr('clear')}}</a>
