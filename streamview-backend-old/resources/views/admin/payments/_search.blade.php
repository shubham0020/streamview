<div class="col-xs-12 mb-2  bottom-space">
    ...
    <form class="col-sm-6 col-sm-offset-6" action="{{route('admin.user.payments')}}" method="GET" role="search">
        @csrf
        <div class="flex right-box">
            <input type="text" value="{{Request::get('search_key')??''}}" class="form-control search_input input-space" name="search_key" placeholder="{{tr('subscription_payments_search_placeholder')}}">
            ...
            <a class="btn btn-default box-left" href="{{route('admin.user.payments')}}">{{tr('clear')}}</a>
