    		...
    		<div class="box box-widget widget-user-2">
            	...
            	<div class="widget-user-header bg-gray">
            		...
            		<div class="pull-left">
	      				...
	      				<h5 class="widget-user-desc"><i class="fa fa-credit-card"></i> {{tr('subscription_payments')}}</h5>
      				</div>
                       ...
                       <ul class="nav nav-stacked">
                            <li>
                                <a href="{{route('admin.users.view',['user_id'=>$payment_details->user_id])}}">{{tr('username')}} 
                                    <span class="text-green pull-right">{{$payment_details->user_name}}
                                    </span></a>
                            </li>
			                <li><a>{{tr('email')}} <span class="pull-right">{{$payment_details->email}}</span></a></li>
			                <li><a>{{tr('mobile')}} <span class="pull-right">{{$payment_details->mobile ? $payment_details->mobile : tr('not_available') }}</span></a></li>
                             
                            
                            <li>
			                	<a href="{{route('admin.subscriptions.view',['subscription_id'=>$payment_details->subscription_id])}}">
                                    {{tr('subscriptions')}} 
			                		<span class="text-green pull-right"> 
                                         {{$payment_details->subscription_name}}
			                        </span>
			                    </a>    
                            </li>
