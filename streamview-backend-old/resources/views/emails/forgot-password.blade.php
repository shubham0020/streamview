                            ...
                            <table border="0" align="center" width="590" cellpadding="0" cellspacing="0" class="container590">
                                <tr>
                                    <td align="center" height="50" style="height:50px;">
                                        <img width="100" border="0" class="mobile-img responsive-img" style="display: block; width:100%;border-top-left-radius:10px;border-top-right-radius:10px; max-height: 20em;" src="{{asset('images/welcome.png')}}" alt="{{Setting::get('site_name')}}" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table border="0" align="center" width="90%" cellpadding="0" cellspacing="0" class="container590 half-width" style="margin-top: 1em;">
                                <tr style="font-size: 14px;color: #ffffff;font-weight: 500;">
                                    <td width="48%" style="width:48%;border: solid 2px #e50914;border-radius: 4px;text-decoration: none;border-spacing: 0;background-color: #e50914;padding: 15px;text-align: center;font-size: 15px;font-weight: 600;letter-spacing: 0.5px;">
                                        <a href="{{$data['url']}}" target="_self" style="font-family: Arial, sans-serif, 'Open Sans';color:#ffffff;text-decoration:none">
                                            {{tr('reset_password')}}
                                        </a>
                                    </td>
                                </tr>
