...
class LanguageController extends Controller
{
    ...
    public function languages_edit(Request $request) {
        ...
        try {
            ...
            return redirect()->route('admin.languages.index')->with('flash_error',$e->getMessage());
        }
    }
            ...
            if ($language_details->delete()) {
                ...
                if($setting_details) {
                    ...
                    if($setting_details->save()) {
                        ...
                        rmdir(base_path().'/resources/lang/'.$folder_name); 
