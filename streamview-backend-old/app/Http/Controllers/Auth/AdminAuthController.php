...
class AdminAuthController extends Controller
{
    ...
    */
    ...
    protected function authenticated(Request $request, Admin $admin){
       ...
       return redirect()->route('admin.dashboard')->with('flash_success',$admin_name."  ".tr('login_success'));
    }
    ...
    public function login(Request $request) {
        ...
        if (\Auth::guard('admin')->attempt(['email' => $request->email, 'password' => $request->password], $request->remember)) {
            ...
            if((\Auth::guard('admin')->user()->is_store == YES) && (\Auth::guard('admin')->user()->status) == DECLINED) {
            ...
            return redirect()->intended(route('admin.dashboard'))->with('flash_success',$admin_name." ".tr('login_success'));
     ...
     *
     * @uses send link to reset password
     *
     * @created Ganesh
     *
     * @updated Ganesh
